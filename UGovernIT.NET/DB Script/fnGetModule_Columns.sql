...
@DefaultColumns NVARCHAR(MAX) ='ID,TicketId, StageStep, Title,Closed,Status, ModuleStepLookup, WorkflowSkipStages, StageActionUsersUser, StageActionUserTypes,CreationDate, Created, Modified,CreatedByUser, ModifiedByUser, CloseDate,CloseoutDate,CloseoutStartDate, OnHold, TenantID, TagMultiLookup, DepartmentLookup'
