CREATE TABLE [dbo].[RCA] (
    ...
    CONSTRAINT [PK_RCA] PRIMARY KEY CLUSTERED ([ID] ASC),
...
GO
CREATE NONCLUSTERED INDEX [IX_RCA_ModuleStepLookup] ON [dbo].[RCA] ([ModuleStepLookup])

GO
CREATE NONCLUSTERED INDEX [IX_RCA_PriorityLookup] ON [dbo].[RCA] ([PriorityLookup])

GO
CREATE NONCLUSTERED INDEX [IX_RCA_Status] ON [dbo].[RCA] ([Status])

GO
CREATE NONCLUSTERED INDEX [IX_RCA_TicketId] ON [dbo].[RCA] ([TicketId])
