...
GO
CREATE NONCLUSTERED INDEX [IX_ModuleWorkflowHistory_ModuleNameLookup] ON [dbo].[ModuleWorkflowHistory] ([ModuleNameLookup])

GO
CREATE NONCLUSTERED INDEX [IX_ModuleWorkflowHistory_TicketId] ON [dbo].[ModuleWorkflowHistory] ([TicketId])
