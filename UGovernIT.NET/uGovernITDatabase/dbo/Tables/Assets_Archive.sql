CREATE TABLE [dbo].[Assets_Archive] (
...
GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_AssetTagNum] ON [dbo].[Assets_Archive] ([AssetTagNum])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_Deleted] ON [dbo].[Assets_Archive] ([Deleted])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_IPAddress] ON [dbo].[Assets_Archive] ([IPAddress])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_ModuleStepLookup] ON [dbo].[Assets_Archive] ([ModuleStepLookup])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_RequestTypeLookup] ON [dbo].[Assets_Archive] ([RequestTypeLookup])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_Status] ON [dbo].[Assets_Archive] ([Status])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_TicketId] ON [dbo].[Assets_Archive] ([TicketId])

GO
CREATE NONCLUSTERED INDEX [IX_Assets_Archive_TSRIdLookup] ON [dbo].[Assets_Archive] ([TSRIdLookup])