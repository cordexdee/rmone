...
GO
CREATE NONCLUSTERED INDEX [IX_TSK_Archive_PriorityLookup] ON [dbo].[TSK_Archive] ([AutoAdjustAllocations], [ModuleStepLookup], [NPRIdLookup], [PriorityLookup], [RequestTypeLookup], [Status], [TicketId])