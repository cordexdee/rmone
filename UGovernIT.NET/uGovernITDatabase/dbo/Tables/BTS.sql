CREATE TABLE [dbo].[BTS] (
    ...
    [Tester2User] NVARCHAR(MAX) NULL, 
    [ClosedByUser] NVARCHAR(MAX) NULL, 
    [ResolvedByUser] NVARCHAR(MAX) NULL, 
    [AssignedByUser] NVARCHAR(MAX) NULL, 
    [IconBlob] VARBINARY(MAX) NULL, 
    [ApprovalDate] DATETIME NULL, 
    [ApprovedByUser] VARCHAR(128) NULL, 
    CONSTRAINT [PK_BTS] PRIMARY KEY CLUSTERED ([ID] ASC),
...
GO
CREATE NONCLUSTERED INDEX [IX_BTS_ModuleStepLookup] ON [dbo].[BTS] ([ModuleStepLookup])

GO
CREATE NONCLUSTERED INDEX [IX_BTS_PriorityLookup] ON [dbo].[BTS] ([PriorityLookup])

GO
CREATE NONCLUSTERED INDEX [IX_BTS_RequestTypeLookup] ON [dbo].[BTS] ([RequestTypeLookup])

GO
CREATE NONCLUSTERED INDEX [IX_BTS_Status] ON [dbo].[BTS] ([Status])

GO
CREATE NONCLUSTERED INDEX [IX_BTS_TicketId] ON [dbo].[BTS] ([TicketId])