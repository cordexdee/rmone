...
GO
CREATE NONCLUSTERED INDEX [IX_INC_Archive_TicketId] ON [dbo].[INC_Archive] ([AssetMultiLookup], [ModuleStepLookup], [PriorityLookup], [RequestTypeLookup], [Status], [TicketId])