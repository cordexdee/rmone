CREATE TABLE [dbo].[DRQ] (
    ...
    [DRQSystemsLookup]                NVARCHAR(MAX)          NULL,
    ...
    CONSTRAINT [PK_DRQ] PRIMARY KEY CLUSTERED ([ID] ASC),
    FOREIGN KEY ([ApplicationMultiLookup]) REFERENCES [dbo].[Applications] ([ID]),
...
GO
CREATE NONCLUSTERED INDEX [IX_DRQ_ModuleStepLookup] ON [dbo].[DRQ] ([ModuleStepLookup])

GO
CREATE NONCLUSTERED INDEX [IX_DRQ_PriorityLookup] ON [dbo].[DRQ] ([PriorityLookup])

GO
CREATE NONCLUSTERED INDEX [IX_DRQ_RequestTypeLookup] ON [dbo].[DRQ] ([RequestTypeLookup])

GO
CREATE NONCLUSTERED INDEX [IX_DRQ_Status] ON [dbo].[DRQ] ([Status])

GO
CREATE NONCLUSTERED INDEX [IX_DRQ_TicketId] ON [dbo].[DRQ] ([TicketId])