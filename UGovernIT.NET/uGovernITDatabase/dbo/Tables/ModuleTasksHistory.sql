CREATE TABLE [dbo].[ModuleTasksHistory] (
...
GO
CREATE NONCLUSTERED INDEX [IX_ModuleTasksHistory_Deleted] ON [dbo].[ModuleTasksHistory] ([Deleted])

GO
CREATE NONCLUSTERED INDEX [IX_ModuleTasksHistory_ModuleName]
    ON [dbo].[ModuleTasksHistory]([ModuleNameLookup] ASC);



GO
CREATE NONCLUSTERED INDEX [IX_ModuleTasksHistory_TicketId] ON [dbo].[ModuleTasksHistory] ([TicketId])
