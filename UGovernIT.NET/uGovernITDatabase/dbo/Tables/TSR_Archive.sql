CREATE TABLE [dbo].[TSR_Archive] (
    ...
    CONSTRAINT [PKK_TSR] PRIMARY KEY CLUSTERED ([ID] ASC)
);
...
CREATE UNIQUE NONCLUSTERED INDEX [IXX_TSR_TicketId] ON [dbo].[TSR] ([TicketId],[TenantID])
