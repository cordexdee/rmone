...
GO
CREATE NONCLUSTERED INDEX [IX_NPR_Archive_PriorityLookup] ON [dbo].[NPR_Archive] ([AutoAdjustAllocations], [ModuleStepLookup], [PMMIdLookup], [VendorName], [PriorityLookup], [RequestTypeLookup], [Status], [TicketId])