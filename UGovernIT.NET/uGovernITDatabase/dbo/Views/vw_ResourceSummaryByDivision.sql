CREATE VIEW dbo.vw_ResourceSummaryByDivision
AS
SELECT DISTINCT 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_ResourceSummaryByDivision';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "CompanyDivisions"
            ...
            TopColumn = 0
         End
         Begin Table = "Summary_ResourceProjectComplexity"
            Begin Extent = 
               Top = 11
               Left = 788
               Bottom = 272
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_ResourceSummaryByDivision';
