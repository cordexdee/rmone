-- select dbo.fnGetPipelineRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','role','Architect')
-- select dbo.fnGetPipelineRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','jobtitle','Assistant Project Manager')
-- select dbo.fnGetPipelineRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','sector','Aviation')
-- select dbo.fnGetPipelineRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','division','1-21 Silicon Valley')
-- select dbo.fnGetPipelineRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','studio','SF Studio 2')
CREATE FUNCTION [dbo].[fnGetPipelineRevenues] 
(
