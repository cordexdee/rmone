-- select dbo.fnGetResourceRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','','role','Architect')
-- select dbo.fnGetResourceRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','','jobtitle','Assistant Project Manager')
-- select dbo.fnGetResourceRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','','sector','Aviation')
-- select dbo.fnGetResourceRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','','division','1-21 Silicon Valley')
-- select dbo.fnGetResourceRevenues('35525396-e5fe-4692-9239-4df9305b915b','2021-01-01','2021-12-31','','studio','SF Studio 1')
-- Used for both Revenues Realized & Committed Revenues, with difference in Date range only.
CREATE FUNCTION [dbo].[fnGetResourceRevenues] 
(
...
BEGIN
	...
	ELSE
		Begin
			Insert into @Tickets select TicketId from dbo.GetContractedProjects(@TenantID,@IsClosed,'','','','','')
		End
