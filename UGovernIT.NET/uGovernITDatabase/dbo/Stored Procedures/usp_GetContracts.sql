CREATE Procedure [dbo].[usp_GetContracts]  
--[usp_GetContracts] 'c345e784-aa08-420f-b11f-2753bbebfdd5' 
...
SET @AllColumnsList= [dbo].[fnGetResolvedColumnsList](@TenantID,'CMT')
SET @strsql='Select  '+ @AllColumnsList+' from Contracts (READCOMMITTED) a where a.TenantID='+ ''''+@TenantID+'''
