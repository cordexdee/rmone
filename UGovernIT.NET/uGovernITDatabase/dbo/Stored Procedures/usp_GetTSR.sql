CREATE Procedure [dbo].[usp_GetTSR]      
--[usp_GetTSR] 'c345e784-aa08-420f-b11f-2753bbebfdd5'   
...
SET @AllColumnsList= [dbo].[fnGetResolvedColumnsList](@TenantID,'TSR')  
SET @strsql='Select  '+ @AllColumnsList+' from TSR (READCOMMITTED) a where a.TenantID='+ ''''+@TenantID+'''  
