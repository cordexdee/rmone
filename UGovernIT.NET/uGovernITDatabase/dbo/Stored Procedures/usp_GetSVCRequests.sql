Create Procedure [dbo].[usp_GetSVCRequests]        
--[usp_GetSVCRequests] 'c345e784-aa08-420f-b11f-2753bbebfdd5'      
...
SET @AllColumnsList= [dbo].[fnGetResolvedColumnsList](@TenantID,'SVC')
SET @strsql='Select  '+ @AllColumnsList+' from SVCRequests (READCOMMITTED) a where a.TenantID='+ ''''+@TenantID+'''
