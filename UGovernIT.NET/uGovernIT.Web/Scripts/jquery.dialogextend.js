  ...
  $.widget("ui.dialogExtend", {
    ...
    _initStyles: function() {
      ...
      if (!$(".dialog-extend-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-restore { width: 20px; height: 20px; margin-right: 2px;}';
    ...
    restore: function() {
      ...
      _restore: function () {
        ...
        this["_restore_" + this._state]();
              ...
              $(".iframeDialog").height('98%');
              $(".iframeDialog").width('98%');
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    maximize: function() {
      ...
      $(this.element[0]).dialog("widget").css("position", "fixed").find(".ui-dialog-content").show().dialog("widget").find(".ui-dialog-buttonpane").show().end().find(".ui-dialog-content").dialog("option", {
        ...
        $(".iframeDialog").height(newHeight - 10);
        $(".iframeDialog").width(newWidth - 10);
    ...
    _initStyles_maximize: function() {
      ...
      if (!$(".dialog-extend-maximize-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-maximize { width: 20px; height: 20px; margin-right: 2px; }';
...
(function() {
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    minimize: function() {
        var dialogcontrols, fixedContainer, newWidth, newHeight;
