<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AssetVendorsNew.ascx.cs" Inherits="uGovernIT.Web.AssetVendorsNew" %>
    ...
    <div class="ms-formtable accomp-popup">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 noPadding">
                ...
                <div class="ms-formbody accomp_inputField">
                    <div class="col-md-10 col-sm-10 col-xs-10 noLeftPadding">
                        <dx:ASPxCallbackPanel ID="refreshdropdown" Width="100%" OnCallback="refreshdropdown_Callback" runat="server" ClientInstanceName="refreshdropdown" RenderMode="Table">
                            <ClientSideEvents EndCallback="function(s,e){setSelectedValue();}" />
                            <PanelCollection>
                                <dx:PanelContent>
                                    <asp:DropDownList ID="ddlVendorType" runat="server" Width="100%" CssClass=" itsmDropDownList aspxDropDownList"></asp:DropDownList>
                                </dx:PanelContent>
                            </PanelCollection>
                        </dx:ASPxCallbackPanel>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2 noPadding">
                        <img id="Img2" runat="server" title="Add Vendor Type" onclick="popupnew.Show();" src="/Content/images/plus-blue.png" width="16" style="margin:0px 0px;" />
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6 noPadding">
                ...
                <div class="ms-formbody accomp_inputField">
                    <asp:DropDownList ID="ddlTimeZone" runat="server" CssClass="itsmDropDownList aspxDropDownList"></asp:DropDownList>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6 noPadding">
                <div class="ms-formlabel">
    ...
    <PanelCollection>
        <dx:PanelContent>
            <dx:ASPxPopupControl ID="popupedit" ClientInstanceName="popupedit" HeaderText="Edit Vendor Type" CloseAction="CloseButton" Width="500px" Height="200px"
                runat="server" EnableViewState="false" PopupHorizontalAlign="WindowCenter"  SettingsAdaptivity-Mode="Always" PopupVerticalAlign="WindowCenter" 
                EnableHierarchyRecreation="True" CssClass="aspxPopup">
                <ContentCollection>
                                ...
                                <div class="row">
                                    ...
                                    <div class="ms-formbody accomp_inputField">
                                        <dx:ASPxTextBox ID="txttitleedit" ValidationSettings-RequiredField-IsRequired="true" ValidationSettings-Display="Dynamic" 
                                            ValidationSettings-ErrorDisplayMode="ImageWithText" ValidationSettings-ErrorText="Title is mandatory"
                                            runat="server" ClientInstanceName="txttitleedit" EnableViewState="false" Width="100%" CssClass="asptextBox-input">
                                        </dx:ASPxTextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="ms-formbody accomp_inputField">
                                        <dx:ASPxMemo ID="txtdesedit" runat="server" CssClass="aspxMemo-linkBox" ClientInstanceName="txtdesedit" Width="100%" 
                                            CaptionSettings-ShowColon="false" EnableViewState="false">
                                        </dx:ASPxMemo>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="ms-formbody accomp_inputField crm-checkWrap">
                                        ...
                                        <%--<dx:ASPxCheckBox ID="chkdeleteedit1" ClientInstanceName="chkdeleteedit" runat="server" EnableViewState="false" 
                                            Text="(Prevent use for new ticket)"></dx:ASPxCheckBox>--%>
                                    </div>
                                </div>
                                <div class="row addEditPopup-btnWrap">
                                     <dx:ASPxButton ID="btnrecycle" runat="server" OnClick="popupdelete_Click" Visible="false" 
                                         CssClass="secondary-cancelBtn" ClientInstanceName="popupdelete" Text="Delete" ToolTip="Delete" AutoPostBack="false">
                                    </dx:ASPxButton>
                                    <dx:ASPxButton ID="btncloseedit" runat="server" CssClass="secondary-cancelBtn" ClientInstanceName="btnclose" Text="Close" 
                                        AutoPostBack="false">
                                        <ClientSideEvents Click="function(s,e){popupedit.Hide();}" />
                                    </dx:ASPxButton>
                                    <dx:ASPxButton ID="btnsaveedit" CssClass="primary-blueBtn" ClientInstanceName="btnsaveedit" runat="server" Text="Save" AutoPostBack="false">
            ...
            <dx:ASPxPopupControl ID="popupnew" ClientInstanceName="popupnew" HeaderText="New Vendor Type" CloseAction="CloseButton"
                ...
                SettingsAdaptivity-Mode="Always" CssClass="aspxPopup">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <div class="col-md-12 col-sm-12 col-xs-12 configVariable-popupWrap">
                            <div class="ms-formtable accomp-popup">
                                <div class="row">
                                    ...
                                    <div class="ms-formbody accomp_inputField">
                                        <dx:ASPxTextBox ID="txttitle" runat="server" ClientInstanceName="txttitle" ValidationSettings-RequiredField-IsRequired="true" 
                                            ValidationSettings-Display="Dynamic" ValidationSettings-ErrorDisplayMode="ImageWithText" Width="100%" CssClass="asptextBox-input" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="ms-formbody accomp_inputField">
                                        <dx:ASPxMemo ID="txtdexcription" runat="server" ClientInstanceName="txtdexcription" CaptionSettings-ShowColon="false" 
                                            EnableViewState="false" CssClass="aspxMemo-linkBox" Width="100%"></dx:ASPxMemo>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="ms-formlabel">
                                    ...
                                    <div class="ms-formbody accomp_inputField crm-checkWrap">
                                        ...
                                        <%--<dx:ASPxCheckBox ID="chkdelete1" ClientInstanceName="chkdelete" ></dx:ASPxCheckBox>--%>
                                    </div>
                                </div>
                                <div class="row addEditPopup-btnWrap">
                                    <dx:ASPxButton ID="btnClose" runat="server" CssClass="secondary-cancelBtn" ClientInstanceName="btnClose" Text="Close" AutoPostBack="false">
                                        <ClientSideEvents Click="function(s,e){ popupnew.Hide()}" />
                                    </dx:ASPxButton>
                                    <dx:ASPxButton ID="ASPxButton1" ClientInstanceName="btnSave" runat="server" CssClass="primary-blueBtn" Text="Save" AutoPostBack="false">
