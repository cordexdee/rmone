<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddUserSkills.ascx.cs" Inherits="uGovernIT.Web.AddUserSkills" %>
...
<div class="col-md-12 col-sm-12 col-xs-12 pt-1">
    <div class="accomp-popup ms-formtable">
        ...
        <div class="row" id="tr12" runat="server">
            ...
            <div class="ms-formbody accomp_inputField">
                <asp:TextBox ID="txtUserSkill" runat="server" />
                <div>
                    <asp:RequiredFieldValidator ID="rfvtxtUserSkill" ValidateEmptyText="true" Enabled="true" runat="server" ControlToValidate="txtUserSkill"
                        ErrorMessage="Enter User Skill" Display="Dynamic" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
