...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentEdit.ascx.cs" Inherits="uGovernIT.Web.DepartmentEdit" %>
...
<div class="col-md-12 col-sm-12 col-xs-12 noPadding configVariable-popupWrap">
    <div class="ms-formtable accomp-popup">
                   ...
                   <asp:TextBox ID="txtTitle" runat="server" OnKeyUp="updateShortName(this.value)"/>
                    <div>
                        <asp:RequiredFieldValidator ID="rfvtxtTitle" ValidateEmptyText="true" Enabled="true" runat="server" ControlToValidate="txtTitle"
                         ...
                         <asp:CustomValidator ID="cvtxtTitle" runat="server" CssClass="error" ControlToValidate="txtTitle" Display="Dynamic" ErrorMessage="Name already exists."
                             OnServerValidate="cvtxtTitle_ServerValidate"  ValidationGroup="Save"></asp:CustomValidator>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-6 col-sm-6" id="divisionTr" runat="server" visible="false">
                <div class="ms-formlabel">
                    <h3 class="ms-standardheader budget_fieldLabel"><%= divisionLevel %><b style="color: Red;">*</b></h3>
                </div>
                <div class="ms-formbody accomp_inputField">
                    <asp:DropDownList runat="server" ID="ddlDivision" CssClass="itsmDropDownList aspxDropDownList"></asp:DropDownList>
                    <div>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="error" ValidateEmptyText="true" Enabled="true" runat="server" ControlToValidate="ddlCompany"
                            ErrorMessage="Please select an option" Display="Dynamic" ValidationGroup="Save"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
        </div>
