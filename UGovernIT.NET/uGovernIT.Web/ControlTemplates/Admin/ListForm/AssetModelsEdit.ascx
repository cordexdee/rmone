...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AssetModelsEdit.ascx.cs" Inherits="uGovernIT.Web.AssetModelsEdit" %>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="ms-formbody accomp_inputField">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Select Vendor" ControlToValidate="ddlVendor" runat="server" ValidationGroup="Save"  ForeColor="Red" />
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="ms-formlabel">
