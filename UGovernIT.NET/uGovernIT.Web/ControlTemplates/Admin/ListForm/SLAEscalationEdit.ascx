...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SLAEscalationEdit.ascx.cs" Inherits="uGovernIT.Web.SLAEscalationEdit" %>
    ...
    <div class="ms-formtable accomp-popup">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6" id="tr3" runat="server">
                ...
                <div class="ms-formbody accomp_inputField">
                    <asp:DropDownList ID="ddlSLARule" Enabled="false" runat="server" CssClass="itsmDropDownList aspxDropDownList" 
                        OnSelectedIndexChanged="ddlSLARule_SelectedIndexChanged" AutoPostBack="true" />
                    <div>
                        <asp:RequiredFieldValidator ID="rfvddlSLARule" ValidateEmptyText="true" Enabled="true" runat="server" ControlToValidate="ddlSLARule"
                            ErrorMessage="Choose SLA Rule " InitialValue="0" Display="Dynamic" ValidationGroup="Save" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
        ...
        <div class="row" id="tr7" runat="server">
            ...
            <div class="ms-formbody accomp_inputField" style="padding-left:15px;">
                <asp:CheckBoxList ID="chklstEscalationRules" runat="server" AutoPostBack="true"
                    OnSelectedIndexChanged="chklstEscalationRules_SelectedIndexChanged" Height="80px" Width="386px" RepeatColumns="2">
                </asp:CheckBoxList>
        ...
        <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-6" id="tr9" runat="server">
                <div class="ms-formbody accomp_inputField crm-checkWrap">
                    <asp:CheckBox ID="cbIncludeActionUser" runat="server" Text="CC to Action User" />
                </div>
            </div>
        ...
        <div class="row" id="tr5" runat="server">
            ...
            <div class="ms-formbody accomp_inputField">
                ...
                <div class="crm-checkWrap col-md-6 col-sm-6 col-xs-6">
      ...
      <div class="row">
        ...
        <div class="row addEditPopup-btnWrap">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <dx:ASPxButton ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel"  OnClick="btnCancel_Click" AutoPostBack="true" CssClass="secondary-cancelBtn">
                </dx:ASPxButton>
                <dx:ASPxButton ID="btnSave" runat="server" Text="Save" ToolTip="Save" ValidationGroup="Save" CssClass="primary-blueBtn"  OnClick="btnSave_Click" AutoPostBack="true" >
                </dx:ASPxButton>
            </div>
        </div>
    </div>
