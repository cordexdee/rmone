...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PriorityNew.ascx.cs" Inherits="uGovernIT.Web.PriorityNew" %>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6" id="tr6" runat="server">
             ...
             <div class="col-md-6 col-sm-6 col-xs-6" id="tr8" runat="server">
                <div class="ms-formbody accomp_inputField crm-checkWrap">
                   <asp:CheckBox ID ="chkAllowPlainText" runat="server" Text="Notify in Plain Text" />
                </div>
            </div>
