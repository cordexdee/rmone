<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MessageBoardNew.ascx.cs" Inherits="uGovernIT.Web.MessageBoardNew" %>
...
<div class="col-md-12 col-sm-12 col-xs-12 configVariable-popupWrap">
    <div class="ms-formtable accomp-popup">
        ...
        <div class="row">
            ...
            <div class="ms-formbody accomp_inputField">
                <asp:TextBox ID="txtBody" TextMode="MultiLine" runat="server" ValidationGroup="Save" />
                <div>                  
        ...
        <div class="row">
            ...
            <div class="ms-formbody accomp_inputField">
                ...
                <%--<SharePoint:DateTimeControl OnValueChangeClientScript="dateChanged()" DateOnly="true"
                    ID="dtcExpires" runat="server" CssClassTextBox="edit-startdate datetimectr datetimectr111 startDateEdit"></SharePoint:DateTimeControl>--%>
