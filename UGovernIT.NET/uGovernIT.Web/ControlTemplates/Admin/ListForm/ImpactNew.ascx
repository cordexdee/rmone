...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImpactNew.ascx.cs" Inherits="uGovernIT.Web.ImpactNew" %>
    ...
    <div class="ms-formtable accomp-popup">
        ...
        <div class="row" id="trTitle" runat="server">
            ...
            <div class="ms-formbody accomp_inputField">
                <ugit:LookUpValueBox ID="ddlModule" runat="server" Width="100%" FieldName="ModuleNameLookup" CssClass="lookupValueBox-dropown" FilterExpression="EnableModule=1" IsMandatory="true"
