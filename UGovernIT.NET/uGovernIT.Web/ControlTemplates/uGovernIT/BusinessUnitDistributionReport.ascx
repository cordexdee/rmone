<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusinessUnitDistributionReport.ascx.cs" Inherits="uGovernIT.Web.BusinessUnitDistributionReport" %>
        ...
        <div style="width: 100%; float: right;">
            <dx:ASPxGridView ID="grdReport" AutoGenerateColumns="False" runat="server" CssClass="customgridview homeGrid" OnLoad="grdReport_Load"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="EstimateNo" Caption="Item ID" CellStyle-HorizontalAlign="Center" Width="150px">
                        <Settings HeaderFilterMode="CheckedList" />
                    ...
                    <dx:GridViewDataTextColumn FieldName="ApproxContractValue" Caption="Approx Contract Value" CellStyle-HorizontalAlign="Right" Width="100px" PropertiesTextEdit-DisplayFormatString="{0:C0}">                                
                        <Settings HeaderFilterMode="CheckedList" />
                    </dx:GridViewDataTextColumn>
