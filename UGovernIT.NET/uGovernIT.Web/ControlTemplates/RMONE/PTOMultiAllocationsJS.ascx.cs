...
{
    public partial class PTOMultiAllocationsJS : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultedTable != null)
                {
                    ...
                    foreach (DataRow row in resultedTable.Rows)
                    {
                        ...
                        {
                            if (row["LevelName"].ToString() != ModuleNames.CPR && row["LevelName"].ToString() != ModuleNames.CNS &&
                                row["LevelName"].ToString() != ModuleNames.OPM)
                            {
            ...
            if (ModuleName == "CPR" || ModuleName == "CNS" || ModuleName == "OPM")
            {
                ...
                if (!string.IsNullOrEmpty(ConstructionEndDateString))
                    CloseOutStartDateString = ConstructionEndDateString;
