...
{
    public partial class ModuleWebpartProperties : UserControl
    {
        public ModuleWebpartDockPanelSetting moduleDockPanelSetting { get; set; }    
        ...
        public void CopyFromWebpart(ModuleWebpartDockPanelSetting webpart)
        {
        ...
        public void CopyFromControl(ModuleWebpartDockPanelSetting webpart)
        {
            webpart.ShowTitle = chkTitle.Checked;
            webpart.Title = txtTitle.Text;
           // webpart.Name = txtName.Text;           
