...
{
    public partial class RecruitmentView : System.Web.UI.UserControl
    {
        ...
        public bool EnableStudioDivisionHierarchy { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            EnableStudioDivisionHierarchy = UGITUtility.StringToBoolean(_configManager.GetValue(ConfigConstants.EnableStudioDivisionHierarchy));
