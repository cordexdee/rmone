<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllOpenOPM.ascx.cs" Inherits="uGovernIT.Web.AllOpenOPM" %>
...
<script type="text/javascript" data-v="<%=UGITUtility.AssemblyVersion %>">
    ...
    $.ajax({
        type: "GET",
        url: "/api/CoreRMM/GetAllOpenOpportunities",
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (message) {

            $("#divOpenOPM").dxTileView({
                items: message,
                baseItemHeight: 100,
                baseItemWidth: 70,
