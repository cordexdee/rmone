<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NPRTicketsDetail.ascx.cs" Inherits="uGovernIT.Web.NPRTicketsDetail" %>
...
<script type="text/javascript" data-v="<%=UGITUtility.AssemblyVersion %>">
    ...
    $.ajax({
        type: "GET",
        url: "/api/CoreRMM/GetNPRTickets",
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (message) {

            $("#divNPRTickets").dxTileView({
                items: message,
                baseItemHeight: 100,
                baseItemWidth: 70,
