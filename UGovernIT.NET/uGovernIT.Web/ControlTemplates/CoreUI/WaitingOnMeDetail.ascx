<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WaitingOnMeDetail.ascx.cs" Inherits="uGovernIT.Web.WaitingOnMeDetail" %>
...
<script type="text/javascript" data-v="<%=UGITUtility.AssemblyVersion %>">
    ...
    $.ajax({
        type: "GET",
        url: "/api/CoreRMM/GetAllWaitingOnMe",
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (message) {

            $("#divWaitingOnMeTickets").dxTileView({
                items: message,
                baseItemHeight: 100,
                baseItemWidth: 70,
                ...
                itemTemplate: function (itemData, itemIndex, itemElement) {
                    ...
                    if (typeof Image == "undefined" || Image == null)
                        itemElement.append("<div class='paneldiv tooltipp'><div class='panelImgDiv'><img  src='/Content/Images/Project.jpg'></div><p class='mb-0'>" + truncateString(itemData.Name, 20) + "<span class='tooltiptext'>" + itemData.Name + "</span></p></div>");
                    else
...
<div class="d-flex align-items-center mt-2">
    <div id="divWaitingOnMeTickets"></div>
