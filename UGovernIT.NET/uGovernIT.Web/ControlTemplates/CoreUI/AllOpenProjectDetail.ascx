<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllOpenProjectDetail.ascx.cs" Inherits="uGovernIT.Web.AllOpenProjectDetail" %>
...
<script type="text/javascript" data-v="<%=UGITUtility.AssemblyVersion %>">
    ...
    $.ajax({
        type: "GET",
        url: "/api/CoreRMM/GetAllOpenProjects",
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (message) {

            $("#divOpenProject").dxTileView({
                items: message,
                baseItemHeight: 100,
                baseItemWidth: 70,
