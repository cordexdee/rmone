<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectReport_SchedulerFilter.ascx.cs" Inherits="uGovernIT.DxReport.ProjectReport_SchedulerFilter" %>
...
<style type="text/css">
    ...
    .rbutton input, input[type="checkbox"] {
        margin-top: 0;
    }
    ...
    .rblistPriority .dxe > table > tbody {
        display: flex;
    }
                        ...
                        <div style="width: 100%; float: left;">
                            ...
                            <fieldset>
                                ...
                                <table style="width: 100%; height: 500px">
                                    ...
                                    <tr>
                                        <td class="ms-formlabel"><%= departmentLabel %> / Functional Area</td>
                                        <td class="ms-formbody">
                                    ...
                                    <tr>
                                        <td class="ms-formlabel">Business Initiative / Project Class</td>
                                        <td class="ms-formbody">
                                            <span style="display: inline-block">
                                ...
                                <table style="width: 100%; height: 500px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ms-formbody">
                                            ...
                                            <div style="float: right;">
                                                <asp:CheckBox runat="server" ID="chkCalculate" TextAlign="Left" class="pl5 spanD"></asp:CheckBox>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ms-component-formlabel">Planned vs Actuals By Category</td>
                                        <td class="ms-formbody">
                        ...
                        <tr>
                            <td style="text-align: right;">
                                <ul style="margin: 0px;">
                                    ...
                                    <li runat="server" id="liSubmit" class="" onmouseover="this.className='tabhover'" onmouseout="this.className=''" style="float: right;">
                                        <asp:LinkButton runat="server" ID="lnkSubmit" Style="color: white; float: right;" Text="Submit" CssClass="ganttImg" OnClick="lnkSubmit_Click" />
                                    </li>
                                </ul>
                            </td>
                        </tr>
