...
{
    public partial class ProjectStatusReport_SchedulerFilter : ReportScheduleFilterBase
    {
        ...
        private void FillForm()
        {
            ...
            if (Id > 0)
            {
                ...
                if (formdic!=null && formdic.Count > 0 && formdic.ContainsKey(ReportScheduleConstant.Report) && Convert.ToString(formdic[ReportScheduleConstant.Report]) == "ProjectStatusReport")
                {
        ...
        {
            Dictionary<string, object> formdic = new Dictionary<string, object>();
            formdic.Add(ReportScheduleConstant.Report, TypeOfReport.ProjectStatusReport);
