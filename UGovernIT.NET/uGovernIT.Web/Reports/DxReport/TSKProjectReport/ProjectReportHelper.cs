...
namespace uGovernIT.DxReport
{
    public class ProjectReportHelper
    {
        ...
        public TSKProjectReportEntity GetProjectReportEntity(ApplicationContext context, TSKProjectReportEntity prEntity, int[] PMMIds, string ticketStatus = "Open")
        {
            ...
            {
                dtallProject = ticketManager.GetOpenTickets(module);
            }
            else if (ticketStatus == "Closed")
            {
                dtallProject = ticketManager.GetClosedTickets(module);
            }
            else
                dtallProject = ticketManager.GetAllTickets(module);
        ...
        public TSKProjectReportEntity GetTSKProjectsEntity(ApplicationContext _context, TSKProjectReportEntity prEntity, int[] tskIds)
        {
            ...
            string companyLogo = context.ConfigManager.GetValue(ConfigConstants.ReportLogo);
            ...
            if (TSKProjects != null && TSKProjects.Rows.Count > 0)
            {
                ...
                dtask.Columns.Add(ConfigConstants.ReportLogo, typeof(string));
        ...
        public void GetDecisionLog(ApplicationContext context, TSKProjectReportEntity prEntity, string queryexpression)
        {
            ...
            lstPmmTicketIds.ForEach(x => commonQueryExpression.Add(string.Format("'{1}'",
                                                           DatabaseObjects.Columns.TicketId, x)));

            if (lstPmmTicketIds.Count > 0)
            {
                ...
                queryexpression = $"{DatabaseObjects.Columns.TicketId} IN (" + string.Join(",", commonQueryExpression) + ")";
                issuesExpressions.Add(queryexpression);
            }
