...
namespace uGovernIT.DxReport
{
    public partial class KeyMileStone : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void BindSummaryTasks(DataTable datatable)
        {
            ...
            xrLblChildCount.DataBindings.Add("Text", null, "ChildCount"); //UGITChildCount
        ...
        private string GetImage(string behaviour)
        {
            ...
            switch (behaviour)
            {
                case Constants.TaskType.Milestone:
                    fileName = @"/Content/images/milestone_icon.png";
                    break;
                case Constants.TaskType.Deliverable:
                    fileName = @"/Content/images/document_down.png";
                    break;
                case Constants.TaskType.Receivable:
                    fileName = @"/Content/images/document_up.png";
                    break;
            }
        ...
        private void xrTCSumTasksDueDate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            DateTime date = UGITUtility.StringToDateTime(xrTCSumTasksDueDate.Text);
            if (date != DateTime.MinValue && date < DateTime.Today && xrTCSumTasksPrecentComplete.Text != "100%")
            {
                xrTCSumTasksDueDate.ForeColor = Color.Red;
                xrTCSumTasksDueDate.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            }
            else
            {
                xrTCSumTasksDueDate.ForeColor = Color.Black;
                xrTCSumTasksDueDate.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            }
        }
