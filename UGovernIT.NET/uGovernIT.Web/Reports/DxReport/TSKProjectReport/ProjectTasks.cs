...
namespace uGovernIT.DxReport
{
    public partial class ProjectTasks : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrTCTasksDueDate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            DateTime date = UGITUtility.StringToDateTime(xrTCTasksDueDate.Text);

            if (date != DateTime.MinValue && date < DateTime.Today && !(string.Compare(xrTCTasksStatus.Text.Trim(), "Completed", true) == 0))
            {
                xrTCTasksDueDate.ForeColor = Color.Red;
                xrTCTasksDueDate.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            }
            else
            {
                xrTCTasksDueDate.ForeColor = Color.Black;
                xrTCTasksDueDate.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            }
        }
