...
namespace uGovernIT.DxReport
{
    public partial class OnePagerReport_Viewer : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            string ticketStatus = Request["TicketStatus"];
            projectYear= Convert.ToInt32(Request["projectYear"]);
            if (ReportHelper.CheckFilterValues(Request.QueryString, paramRequired) == false)
            {
                ReportFilterURl = delegateControl + "?reportName=OnePagerReport&Filter=Filter&Module=" + Module + "&alltickets=" + UGITUtility.ObjectToString(Request["alltickets"]);
            ...
            entity = onePagerHelper.GetOnePagerReportEntity(ticketStatus);
