<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SummaryByTechnician_SchedulerFilter.ascx.cs" Inherits="uGovernIT.DxReport.SummaryByTechnician_SchedulerFilter" %>
...
<dx:ASPxCallbackPanel ID="cbpnlMain" OnCallback="cbpnlMain_Callback" ClientInstanceName="cbpnlMain" runat="server" CssClass="filterBlock">
                    ...
                    <div id="container_1">
                        <table style="padding-top: 10px; width: 100%">
                                <tr>
                                    ...
                                    <td class="cusList" style="margin: 5px 0 5px 8px;">
                                        <!-- select all boxes -->
                                        <div class="px10" style="overflow: auto; max-height: 150px; border: 1px solid #bbb">
                                        ...
                                        <asp:CheckBox ID="chkSmryByTechSortByModule" runat="server" Checked="false" Style="display: none; margin-top: 5px; font-weight: 600;" Text="Sort By Module First" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="top_right_nav" style="left: 0px; float: left; margin-top: 6px;margin-bottom: 6px; width: 100%;">
                                            <span id="spanNoOfDays" runat="server" visible="false" style="float: left; width: 100%; margin: 5px; margin-left: 0px">
                                   
                                                <span style="float: left;padding-top:5px;margin-left:0">From:</span>
