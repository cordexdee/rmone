<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusinessUnitDistribution_Filter.ascx.cs" Inherits="uGovernIT.DxReport.BusinessUnitDistribution_Filter" %>
...
<script type="text/javascript">
    function GetBUDReportPopup(obj) {
        ...
        if (tbDivision.GetValue() != null && tbDivision.GetValue().length > 0)
            division = tbDivision.GetValue().join(',');
        ...
        var url = '<%=BusinessunitdistributionReportURL %>' + "?reportName=BusinessUnitDistribution&Module=" + moduleName + "&dtStart=" + StartDate + "&dtEnd="
            + EndDate + "&divisions=" + division + "&showReport=true";
        LoadingPanel.Show();
...
<div id="dvCLJR" class="col-md-12 col-sm-12 col-xs-12">
    <fieldset class="px-4">
           ...
           <div class="col-md-4 col-sm-6 col-xs-12 noPadding">
                <div>
                    ...
                    <div class="studio-dropDownWrap" style="width:100%">
                        <ugit:LookUpValueBox ID="tbDivision" ClientInstanceName="tbDivision" runat="server" IsMulti="true" CssClass="rmmLookup-valueBoxEdit"
                            FieldName="DivisionLookup" />
                        <%--<dx:ASPxTokenBox ID="tbDivision" runat="server" Width="100%" cssClass="aspxUserTokenBox-control" ClientInstanceName="tbDivision" 
        ...
        <div class="row summaryReport-btnWrap">
            <div class="pt-3 col-md-4 col-sm-4 col-xs-12 px-0">
