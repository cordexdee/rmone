<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusinessUnitDistribution_Viewer.ascx.cs" Inherits="uGovernIT.DxReport.BusinessUnitDistribution_Viewer" %>
