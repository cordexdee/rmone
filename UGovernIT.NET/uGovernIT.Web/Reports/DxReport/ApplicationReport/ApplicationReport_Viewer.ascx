<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplicationReport_Viewer.ascx.cs" Inherits="uGovernIT.DxReport.ApplicationReport.ApplicationReport_Viewer" %>
