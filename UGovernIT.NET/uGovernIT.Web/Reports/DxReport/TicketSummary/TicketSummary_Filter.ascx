...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TicketSummary_Filter.ascx.cs" Inherits="uGovernIT.DxReport.TicketSummary_Filter" %>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 noPadding ms-formtable accomp-popup" id="wrapper_1">
                    <div class="row" id="container_1">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="px-0 accomp_inputField">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 pl-2 pr-0">
                                    <div class="ms-formlabel">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                             <dx:ASPxLoadingPanel ID="reportLoadingPanel" ClientInstanceName="reportLoadingPanel" runat="server" Modal="true" Image-Url="~/Content/IMAGES/AjaxLoader.gif" ImagePosition="Top" Text="Loading.." CssClass="customeLoader"></dx:ASPxLoadingPanel>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
