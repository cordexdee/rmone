...
namespace uGovernIT.Web {
    public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page
    {
        ...
        {
            manager = Context.GetOwinContext().GetUserManager<UserProfileManager>();
        ...
        protected void CodeSubmit_Click(object sender, EventArgs e)
        {
            ...
            var result = signinManager.TwoFactorSignIn<UserProfile, string>(HiddenField["Provider"].ToString(), Code.Text, isPersistent: rememberMe, rememberBrowser: RememberBrowser.Checked);
            switch (result)
            {
