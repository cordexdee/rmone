<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulerReport.aspx.cs" Inherits="uGovernIT.SchedulerReport" %>
...
<body>
    <form id="form1" runat="server">
       <asp:Panel ID="DelegatePanel" runat="server"></asp:Panel>
    </form>
</body>
</html>
