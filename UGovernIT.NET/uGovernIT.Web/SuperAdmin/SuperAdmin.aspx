<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/Main.master" CodeBehind="SuperAdmin.aspx.cs" Inherits="uGovernIT.Web.SuperAdmin" %>
<%@ Register Src="~/ControlTemplates/Admin/TenantInfoSuperAdmin.ascx" TagName="uc" TagPrefix="trialGrid" %>
