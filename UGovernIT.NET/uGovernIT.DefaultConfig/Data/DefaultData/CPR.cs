...
namespace uGovernIT.DefaultConfig.Data.DefaultData
{
    public class CPR : IModule
    {
        ...
        public UGITModule Module
        {
            get
            {
                return new UGITModule()
                {
                    ...
                    ModuleTable = "CRMProject",
                    ModuleAutoApprove = false,
                    ModuleRelativePagePath = "/Pages/CRMProject",
                    ModuleHoldMaxStage = 3,
                    Title = "Project Management (CPR)",
                    ...
                    ThemeColor = "Accent1",
                    StaticModulePagePath = "/Pages/CPR",
        ...
        public List<ModuleFormTab> GetFormTabs()
        {
            ...
            mList.Add(new ModuleFormTab() { TabName = "Permits", TabId = 9, TabSequence = 9, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "Permits" });
            ...
            mList.Add(new ModuleFormTab() { TabName = "SubContractor", TabId = 11, TabSequence = 11, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "SubContractor" });
            mList.Add(new ModuleFormTab() { TabName = "Emails", TabId = 12, TabSequence = 12, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "Emails" });
            mList.Add(new ModuleFormTab() { TabName = "Comments", TabId = 13, TabSequence = 13, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "Comments" });
            mList.Add(new ModuleFormTab() { TabName = "History", TabId = 14, TabSequence = 14, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "History" });
            mList.Add(new ModuleFormTab() { TabName = "Owner Contract", TabId = 16, TabSequence = 16, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "Owner Contract" });
            mList.Add(new ModuleFormTab() { TabName = "Statistics", TabId = 17, TabSequence = 17, ModuleNameLookup = ModuleName, CustomProperties = "", Title = ModuleName + " - " + "Statistics" });
        ...
        public List<LifeCycleStage> GetLifeCycleStage()
        {
            ...
            mList.Add(new LifeCycleStage()
            {
                Name = "Initiate",
                StageTitle = "Initiate",
                UserWorkflowStatus = "Initiate new CRM project request",
                UserPrompt = "<b>Please fill the form to open a new CPR ticket.</b>",
                StageStep = ++StageStep,
                ...
                StageReturnStatus = 0,
                ApproveActionDescription = "Request Submitted",
                RejectActionDescription = "",
                ReturnActionDescription = "",
                StageApproveButtonName = "Review",
            ...
            mList.Add(new LifeCycleStage()
            {
                ...
                RejectActionDescription = "",
                ReturnActionDescription = "",
                StageApproveButtonName = "Approach",
                StageRejectedButtonName = "Loss/Cancel",
            ...
            mList.Add(new LifeCycleStage()
            {
                Name = "Develop Approach",
                StageTitle = "Develop Approach",
            ...
            mList.Add(new LifeCycleStage()
            {
                ...
                RejectActionDescription = "",
                ReturnActionDescription = "",
                StageApproveButtonName = "Waiting",
                StageRejectedButtonName = "Loss/Cancel",
                StageReturnButtonName = "Go Back",
                StageAllApprovalsRequired = false,
                StageWeight = 5,
        ...
        public List<ModuleColumn> GetModuleColumns()
        {
            ...
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "RequestTypeLookup", FieldDisplayName = "Project Type", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = false, ShowInMobile = true, CustomProperties = "", ColumnType = null, TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "Title", FieldDisplayName = "Project", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = true, ShowInMobile = true, CustomProperties = "", ColumnType = null, TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "CRMCompanyLookup", FieldDisplayName = "Company", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = true, CustomProperties = "", ColumnType = null, TextAlignment = "Left" });
            ...
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "EstimatedConstructionStart", FieldDisplayName = "Construction Start", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = true, ShowInMobile = true, CustomProperties = "", ColumnType = "Date", TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "EstimatedConstructionEnd", FieldDisplayName = "Const. End", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = true, ShowInMobile = false, CustomProperties = "", ColumnType = "Date", TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "ProjectedBudget", FieldDisplayName = "Projected Budget", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = true, CustomProperties = "miniview=True", ColumnType = null, TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "RevisedBudget", FieldDisplayName = "Budget", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = true, CustomProperties = "", ColumnType = null, TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "ApproxContractValue", FieldDisplayName = "Contract", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = true, ShowInMobile = true, CustomProperties = "", ColumnType = "Currency", TextAlignment = null });
            ...
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "Comment", FieldDisplayName = "Comment", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = false, CustomProperties = "", ColumnType = "String", TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "MarketSector", FieldDisplayName = "Market Sector", FieldSequence = (++seqNum), IsDisplay = true, DisplayForClosed = false, ShowInMobile = false, CustomProperties = "", ColumnType = "String", TextAlignment = "Left" });
            ...
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "CreationDate", FieldDisplayName = "Created on", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = false, CustomProperties = "", ColumnType = "DateTime", TextAlignment = null });
            mList.Add(new ModuleColumn() { CategoryName = ModuleName, FieldName = "PreconStartDate", FieldDisplayName = "Precon Start Date", FieldSequence = (++seqNum), IsDisplay = false, DisplayForClosed = false, ShowInMobile = false, CustomProperties = "", ColumnType = "DateTime", TextAlignment = null });
        ...
        public List<ModuleFormLayout> GetModuleFormLayout()
        {
            ...
            mList.Add(new ModuleFormLayout() { Title = "Project Type", FieldDisplayName = "Project Type", FieldName = "RequestTypeLookup", ModuleNameLookup = ModuleName, TabId = 0, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            //mList.Add(new ModuleFormLayout() { Title = "Project Complexity", FieldDisplayName = "Project Complexity", FieldName = "CRMProjectComplexity", ModuleNameLookup = ModuleName, TabId = 0, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Precon End Date", FieldDisplayName = "Precon End Date", FieldName = "PreconEndDate", ModuleNameLookup = ModuleName, TabId = 0, FieldDisplayWidth = 2, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            ...
            mList.Add(new ModuleFormLayout() { Title = "BCCI Sector", FieldDisplayName = "BCCI Sector", FieldName = "SectorChoice", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 2, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Related OPM ID", FieldDisplayName = "Related OPM ID", FieldName = "OPMIdLookup", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Project Type", FieldDisplayName = "Project Type", FieldName = "RequestTypeLookup", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Project Template", FieldDisplayName = "Project Template", FieldName = "ProjectTemplate", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Additional Info", FieldDisplayName = "Additional Info", FieldName = "AdditionalInfo", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            ...
            mList.Add(new ModuleFormLayout() { Title = "Precon End Date", FieldDisplayName = "Precon End Date", FieldName = "PreconEndDate", ModuleNameLookup = ModuleName, TabId = 2, FieldDisplayWidth = 2, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            ...
            mList.Add(new ModuleFormLayout() { Title = "AVG Days To Respond To RFIs", FieldDisplayName = "AVG Days To Respond To RFIs", FieldName = "DaysToRespondToRFIs", ModuleNameLookup = ModuleName, TabId = 7, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            ...
            seqNum = 0;
            //9
            mList.Add(new ModuleFormLayout() { Title = "Permit", FieldDisplayName = "Permit", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 9, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "CPRPermit", FieldDisplayName = "CPRPermit", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 9, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "Permit", FieldDisplayName = "Permit", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 9, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });

            seqNum = 0;
            //10
            mList.Add(new ModuleFormLayout() { Title = "Resource Availability", FieldDisplayName = "Resource Availability", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 10, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "ResourceAvailability", FieldDisplayName = "ResourceAvailability", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 10, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "Resource Availability", FieldDisplayName = "Resource Availability", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 10, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });

            seqNum = 0;
            //11
            mList.Add(new ModuleFormLayout() { Title = "Commitments", FieldDisplayName = "Commitments", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 11, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "ViewSubContractor", FieldDisplayName = "ViewSubContractor", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 11, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "Commitments", FieldDisplayName = "Commitments", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 11, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });

            seqNum = 0;
            //12
            mList.Add(new ModuleFormLayout() { Title = "Emails", FieldDisplayName = "Emails", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 12, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "Emails", FieldDisplayName = "Emails", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 12, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "Emails", FieldDisplayName = "Emails", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 12, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = true });

            seqNum = 0;
            //13
            mList.Add(new ModuleFormLayout() { Title = "Comments", FieldDisplayName = "Comments", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 13, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Add Comment", FieldDisplayName = "Add Comment", FieldName = "Comment", ModuleNameLookup = ModuleName, TabId = 13, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Comments", FieldDisplayName = "Comments", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 13, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });

            seqNum = 0;
            //14
            mList.Add(new ModuleFormLayout() { Title = "History", FieldDisplayName = "History", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 14, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "History", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "History", FieldDisplayName = "History", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 14, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "IsReadOnly=True;#IsInFrame=False", FieldSequence = (++seqNum), HideInTemplate = true });
            mList.Add(new ModuleFormLayout() { Title = "History", FieldDisplayName = "History", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 14, FieldDisplayWidth = 3, ShowInMobile = true, CustomProperties = "History", FieldSequence = (++seqNum), HideInTemplate = true });
            
            seqNum = 0;
            //16
            mList.Add(new ModuleFormLayout() { Title = "Contract Details", FieldDisplayName = "Contract Details", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "CRMOwnerContractDetails", FieldDisplayName = "CRMOwnerContractDetails", FieldName = "#Control#", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Contract Details", FieldDisplayName = "Contract Details", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Waiver of Consequential Damages", FieldDisplayName = "Waiver of Consequential Damages", FieldName = "WaiverDamages", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Lien Waivers", FieldDisplayName = "Lien Waivers", FieldName = "LienWaiver", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Retainage", FieldDisplayName = "Retainage", FieldName = "Retainage", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Waiver of Subrogation", FieldDisplayName = "Waiver of Subrogation", FieldName = "WaiverSubrogation", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Subcontractor Default Insurance", FieldDisplayName = "Subcontractor Default Insurance", FieldName = "SubcontractorDefaultInsurance", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Diverse Certifications", FieldDisplayName = "Diverse Certifications", FieldName = "DiverseCertificationChoice", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Dispute Resolution", FieldDisplayName = "Dispute Resolution", FieldName = "DisputeResolution", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Payment & Performance Bonds", FieldDisplayName = "Payment & Performance Bonds", FieldName = "PaymentAndPerformanceBonds", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Executive Order 11246 Requirements", FieldDisplayName = "Executive Order 11246 Requirements", FieldName = "ExecutiveOrderRequirements", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Bonus/Incentive", FieldDisplayName = "Bonus/Incentive", FieldName = "Bonus", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Extended General Conditions for Delay", FieldDisplayName = "Extended General Conditions for Delay", FieldName = "GeneralConditionsDelay", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Subcontractor Mark-Ups", FieldDisplayName = "Subcontractor Mark-Ups", FieldName = "SubContractorMarkUp", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Liquidated Damages", FieldDisplayName = "Liquidated Damages", FieldName = "LiquidatedDamages", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Change Orders", FieldDisplayName = "Change Orders", FieldName = "ApprovedChangeOrders", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Builder`s Risk", FieldDisplayName = "Builder`s Risk", FieldName = "BuilderRisk", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Disputed Work Cap", FieldDisplayName = "Disputed Work Cap", FieldName = "DisputedWorkCap", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Certifying Agency", FieldDisplayName = "Certifying Agency", FieldName = "CertifyingAgency", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Savings", FieldDisplayName = "Savings", FieldName = "Savings", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Payments", FieldDisplayName = "Payments", FieldName = "Payments", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "ContractStatusChoice", FieldDisplayName = "ContractStatusChoice", FieldName = "ContractStatusChoice", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "RetainageChoice", FieldDisplayName = "RetainageChoice", FieldName = "RetainageChoice", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "ContractNotes", FieldDisplayName = "ContractNotes", FieldName = "ContractNotes", ModuleNameLookup = ModuleName, TabId = 16, FieldDisplayWidth = 3, ShowInMobile = false, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });

            seqNum = 0;
            //17
            mList.Add(new ModuleFormLayout() { Title = "Project Statistics", FieldDisplayName = "Project Statistics", FieldName = "#GroupStart#", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Tags", FieldDisplayName = "#Tags", FieldName = "NumTags", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Unique Roles", FieldDisplayName = "#Unique Roles", FieldName = "NumUniqueRoles", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Allocations", FieldDisplayName = "#Allocations", FieldName = "NumAllocations", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Contract Amount Changes", FieldDisplayName = "#Contract Amount Changes", FieldName = "NumContractAmountChanges", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "% of Contract Amount Change", FieldDisplayName = "% of Contract Amount Change", FieldName = "PerContractAmountChange", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Resource Allocation Changes", FieldDisplayName = "#Resource Allocation Changes", FieldName = "NumResourceAllocationChanges", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "#Schedule Changes", FieldDisplayName = "#Schedule Changes", FieldName = "NumScheduleChanges", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "% of Schedule Changes", FieldDisplayName = "% of Schedule Changes", FieldName = "PerScheduleChanges", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "% of Time Taken To Fill Unfilled Roles", FieldDisplayName = "% of Time Taken To Fill Unfilled Roles", FieldName = "PerTimeTakenToFillUnfilledRoles", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
            mList.Add(new ModuleFormLayout() { Title = "Project Statistics", FieldDisplayName = "Project Statistics", FieldName = "#GroupEnd#", ModuleNameLookup = ModuleName, TabId = 17, FieldDisplayWidth = 1, ShowInMobile = true, CustomProperties = "", FieldSequence = (++seqNum), HideInTemplate = false });
        ...
        public List<ModuleRequestType> GetModuleRequestType()
        {
            ...
            mList.Add(new ModuleRequestType() { Title = "Construction > Base Building > Corridors", ModuleNameLookup = ModuleName, RequestType = "Corridors", Category = "Construction", SubCategory = "Seismic Structural - 07", FunctionalAreaLookup = 16, WorkflowType = "Full", Owner = null, Deleted = false });
            ...
            mList.Add(new ModuleRequestType() { Title = "Core And Shell", ModuleNameLookup = ModuleName, RequestType = "Core And Shell", Category = "Construction", SubCategory = "Seismic Structural - 07", FunctionalAreaLookup = 16, WorkflowType = "Full", Owner = null, Deleted = false });
            ...
            mList.Add(new ModuleRequestType() { Title = "Architecture", ModuleNameLookup = ModuleName, RequestType = "Architecture", Category = "Professional Services", SubCategory = "Architecture - 02", FunctionalAreaLookup = 9, WorkflowType = "Full", Owner = null, Deleted = true });
            ...
            mList.Add(new ModuleRequestType() { Title = "Construction Management", ModuleNameLookup = ModuleName, RequestType = "Construction Management", Category = "Professional Services", SubCategory = "Construction Management - 02", FunctionalAreaLookup = 9, WorkflowType = "Full", Owner = null, Deleted = false });
        ...
        public List<ModuleRoleWriteAccess> GetModuleRoleWriteAccess()
        {
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "BuildingOwnerCompany", FieldName = "BuildingOwnerCompany", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "ContactLookup", FieldName = "ContactLookup", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "MarketSector", FieldName = "MarketSector", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = false, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "ProjectTemplate", FieldName = "ProjectTemplate", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "Description", FieldName = "Description", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            mList.Add(new ModuleRoleWriteAccess() { Title = "BCCISector", FieldName = "SectorChoice", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "SignedNDA", FieldName = "SignedNDA", StageStep = 0, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 1, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            mList.Add(new ModuleRoleWriteAccess() { Title = "BCCISector", FieldName = "SectorChoice", StageStep = 1, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 2, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });


            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 3, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "DaysToRespondToRFIs", FieldName = "DaysToRespondToRFIs", StageStep = 4, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 4, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });


            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 5, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });

            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 6, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            mList.Add(new ModuleRoleWriteAccess() { Title = "DaysToRespondToRFIs", FieldName = "DaysToRespondToRFIs", StageStep = 7, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
            ...
            //mList.Add(new ModuleRoleWriteAccess() { Title = "CRMProjectComplexity", FieldName = "CRMProjectComplexity", StageStep = 7, ModuleNameLookup = ModuleName, FieldMandatory = false, ShowEditButton = true, ShowWithCheckbox = false, HideInServiceMapping = false });
        ...
        public List<TabView> UpdateTabView()
        {
            ...
            tabs.Add(new TabView() { TabName = "unassigned", TabDisplayName = "UnAssigned", ViewName = "CRMProject", TabOrder = 1, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "Unassigned" });
            tabs.Add(new TabView() { TabName = "waitingonme", TabDisplayName = "Waiting On Me", ViewName = "CRMProject", TabOrder = 2, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "Waiting On Me" });
            tabs.Add(new TabView() { TabName = "myopentickets", TabDisplayName = "My Open Tickets", ViewName = "CRMProject", TabOrder = 3, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "My Open Items" });
            tabs.Add(new TabView() { TabName = "mygrouptickets", TabDisplayName = "My Group Tickets", ViewName = "CRMProject", TabOrder = 4, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "My Group Items" });
            tabs.Add(new TabView() { TabName = "departmentticket", TabDisplayName = "Department Tickets", ViewName = "CRMProject", TabOrder = 5, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "Department Items" });
            tabs.Add(new TabView() { TabName = "allopentickets", TabDisplayName = "Pipeline", ViewName = "CRMProject", TabOrder = 6, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = true, TablabelName = "Open Items" });
            tabs.Add(new TabView() { TabName = "allresolvedtickets", TabDisplayName = "Under Construction", ViewName = "CRMProject", TabOrder = 7, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = true, TablabelName = "Resolved Items" });
            tabs.Add(new TabView() { TabName = "alltickets", TabDisplayName = "All Tickets", ViewName = "CRMProject", TabOrder = 8, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = false, TablabelName = "All Items" });
            tabs.Add(new TabView() { TabName = "allclosedtickets", TabDisplayName = "Closed", ViewName = "CRMProject", TabOrder = 9, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = true, TablabelName = "Closed Items" });
            tabs.Add(new TabView() { TabName = "onhold", TabDisplayName = "On Hold", ViewName = "CRMProject", TabOrder = 10, ModuleNameLookup = ModuleName, ColumnViewName = "MyHomeTab", ShowTab = true, TablabelName = "On Hold" });
