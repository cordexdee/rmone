...

{
    public partial class BusinessUnitDistribution_Viewer : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            //paramRequired.Add("dtEnd");//Commented by chetan.
            ...
            {
                //ReportFilterURl = ApplicationContext.ReportUrl + delegateControl + "?reportName=BusinessUnitDistribution&Filter=Filter&Module=" + Module;
        ...
        private DataTable LoadData()
        {
            ...
            */
            ...
            if (!string.IsNullOrEmpty(Divisions))
            {
                ...
                drResults = dtResult.Select($"{DatabaseObjects.Columns.CRMBusinessUnit} in ({string.Join(",", Divisions.Split(',').Select(x => string.Format("'{0}'", x)).ToList())})");
