<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudioSpecific_Filter.ascx.cs" Inherits="uGovernIT.Report.DxReport.StudioSpecific_Filter" %>
...
<script type="text/javascript">
    function GetStudioSpecificReportPopup(obj) {
        ...
        LoadingPanel.Show();
        var url = '<%=StudioSpecificReportURL %>' + "?reportName=StudioSpecific&Module=" + moduleName + "&dtStart=" + StartDate + "&dtEnd=" + EndDate + "&studios=" + tbStudio.values.join(',') + "&showReport=true";
           ...
           <div class="col-md-4 col-sm-6 col-xs-12 noPadding">
                <div>
                    ...
                    <div class="studio-dropDownWrap" style="width:100%">
                        <dx:ASPxTokenBox ID="tbStudio" runat="server" Width="100%" cssClass="aspxUserTokenBox-control" ClientInstanceName="tbStudio" IncrementalFilteringMode="Contains"></dx:ASPxTokenBox>
                    </div>
                </div>
           </div>
        </div>
