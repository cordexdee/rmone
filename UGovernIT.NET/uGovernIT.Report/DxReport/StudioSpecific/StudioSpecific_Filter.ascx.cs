...
namespace uGovernIT.Report.DxReport
{
    public partial class StudioSpecific_Filter : UserControl
    {
        ...
        {
            ModuleName = "CPR";
            StudioSpecificReportURL = ApplicationContext.SiteUrl + "BuildReport.aspx";
        }
        ...
        {
            string studios = FieldConfigurationManager.Load(x => x.FieldName == DatabaseObjects.Columns.Studio).FirstOrDefault().Data;
