<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NonPeakHoursPerformance_Viewer.ascx.cs" Inherits="uGovernIT.Report.DxReport.NonPeakHoursPerformance_Viewer" %>
...
<%@ Register Assembly="DevExpress.XtraReports.v22.1.Web.WebForms, Version=22.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraReports.Web" TagPrefix="dx" %>
 <script type="text/javascript">
    function OpenSendEmailWindow(url) {
        ...
        UgitOpenPopupDialog(url, '', 'Send Email - HelpDesk Performance Report', '800px', '600px', 0, escape(requestUrl))
        return false;
    }
...
<asp:Panel runat="server" ID="pnlReport" Width="100%">
    ...
    <asp:HiddenField runat="server" ID="hdnPDFGenerated" />
      <dx:ReportToolbar ID="RptToolBar" runat='server' Width="100%" ShowDefaultButtons='False'
                            ReportViewerID="RptHelpDeskPerformanceReport" Theme="DevEx" >
                            <Items>
                        ...
                        <dx:ReportViewer ID="RptHelpDeskPerformanceReport" runat="server" Width="100%" Height="850px" AutoSize="false">
