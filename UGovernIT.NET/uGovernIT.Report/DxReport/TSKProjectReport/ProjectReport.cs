...
namespace uGovernIT.Report.DxReport
{
    public partial class ProjectReport : XtraReport
    {
        ...
        public ProjectReport(TSKProjectReportEntity projectReport)
        {
            ...
            xrTCPrecentComplete.DataBindings.Add("Text", null, "PctComplete", "{0:0.00%}");
            ...
            //xrpbPHCompanyLogo.DataBindings.Add("ImageUrl", null, "CompanyLogo");
            ...
            // xrpbCompanyLogo.DataBindings.Add("ImageUrl", null, "CompanyLogo");
            if (projectEntity.CompanyLogoBitmap != null)
        ...
        private void xrTCProjManager_BeforePrint(object sender, PrintEventArgs e)
        {
            ...
            string title = GetLookupValues(DatabaseObjects.Columns.TicketProjectManager, Convert.ToString(this.GetCurrentColumnValue(DatabaseObjects.Columns.TicketProjectManager)));
            label.Text = title;
        }
        ...
        private void BindProjectBudgetSummary(DataTable dt)
        {
            ...
            EstProjectspend = obj != null ? (obj.Spend == null ? 0 : obj.Spend) : 0;
