...
{
    public class ResourceUsage_Report : DevExpress.XtraReports.UI.XtraReport
    {
        private System.ComponentModel.IContainer components = null;

        public ResourceUsage_Report(DataTable datatable)
        {
            InitializeComponent();
        ...
        private void BindAllTasks(DataTable datatable)
        {
            ...
            xrTableCellResource.DataBindings.Add("Text", null, "ResourceUser");
