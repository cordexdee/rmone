<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CombinedLostJobReport_Filter.ascx.cs" Inherits="uGovernIT.Report.DxReport.CombinedLostJobReport_Filter" %>
...
<div id="dvCLJR" class="col-md-12 col-sm-12 col-xs-12">
    <fieldset class="projectsummary-reportContainer">
        ...
        <div class="row summaryReport-btnWrap">
            <div class="summaryReport-btnContainer col-md-6 col-sm-6 col-xs-12 noPadding">
