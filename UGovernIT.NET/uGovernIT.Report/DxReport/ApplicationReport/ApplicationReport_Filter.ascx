<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplicationReport_Filter.ascx.cs" Inherits="uGovernIT.Report.DxReport.ApplicationReport.ApplicationReport_Filter" %>
