...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectReport_Viewer.ascx.cs" Inherits="uGovernIT.Report.DxReport.ProjectReport_Viewer" %>
...
<script type="text/javascript">
    function OpenSendEmailWindow(url) {
        ...
        UgitOpenPopupDialog(url, '', 'Send Email - Project Summary Report', '800px', '600px', 0, escape(requestUrl))
        return false;
    }
...
<asp:Panel runat="server" ID="pnlReport" Width="100%">
    ...
    <dx:ReportToolbar ID="RptToolBar" runat='server' Width="100%" ShowDefaultButtons='False'
        ReportViewerID="RptVwrProjectReport"  >
        <Items>
            ...
            <dx:ReportToolbarTemplateItem>
                <Template>
                    <dx:ASPxButton ID="SendEmail" runat="server" RenderMode="Link" CssClass="export-buttons" AutoPostBack="false"
            ...
            <dx:ReportToolbarTemplateItem Name="AttachToDocumentTemplate" >
                <Template>
                    <dx:ASPxButton ID="AttachToDocument" runat="server"  RenderMode="Link" CssClass="export-buttons" AutoPostBack="false"
                        EnableTheming="false" UseSubmitBehavior="False" >
    ...
    <dx:ReportViewer ID="RptVwrProjectReport" runat="server" Width="100%" Height="100%" AutoSize="true">
