...
namespace uGovernIT.Report.DxReport
{
    public partial class ProjectReport_Viewer : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                ReportFilterURl = _context.SiteUrl + delegateControl + "?reportName=ProjectReport&Filter=Filter&Module=" + Module + "&alltickets=" + UGITUtility.ObjectToString(Request["alltickets"]);
