...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectResourceReport_Filter.ascx.cs" Inherits="uGovernIT.Report.DxReport.ProjectResourceReport_Filter" %>
