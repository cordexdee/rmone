...
using uGovernIT.Report.DxReport;
...
namespace uGovernIT.Report.DxReport
{
    public partial class ProjectStatusReport_Viewer : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                ReportFilterURl = _context.SiteUrl + delegateControl + "?reportName=ProjectStatusReport&Filter=Filter&Module=" + Module + "&alltickets=" + UGITUtility.ObjectToString(Request["alltickets"]);
            ...
            prEntity = proRepHelper.GetProjectReportEntity(_context, prEntity, PMMIds);
