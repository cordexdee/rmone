<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurveyFeedbackReport_Viewer.ascx.cs" Inherits="uGovernIT.Report.DxReport.SurveyFeedbackReport_Viewer" %>
...
<script type="text/javascript">
    ...
    function OpenSendEmailWindow(url) {
        ...
        UgitOpenPopupDialog(url, '', 'Send Email - Survey Feedback Report', '800px', '600px', 0, escape(requestUrl))
        return false;
    }
...
<asp:Panel runat="server" ID="pnlSurveyFeedbackReport" Width="100%">
    ...
    <dx:ReportToolbar ID="RptToolBar" runat='server' Width="100%" ShowDefaultButtons='False'
        ...
        <Items>
            ...
            <dx:ReportToolbarTemplateItem>
                <Template>
                    <dx:ASPxButton ID="SendEmail" RenderMode="Link" runat="server" CssClass="export-buttons" AutoPostBack="false" ToolTip="Email Report"
    ...
    <dx:ReportViewer ID="RptVwrProjectReport" runat="server" Width="100%" Height="850px" AutoSize="false" PageByPage="false">
